<div class="py-5" style="background-image: url('https://getbuzzmonitor.com/wp-content/uploads/buzz-1.png'); background-attachment: fixed; background-size: cover; background-position: center;">
    <x-slot name="header">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-transparent overflow-hidden shadow-xl sm:rounded-lg px-4 py-4 dark:bg-gray-800/50 dark:bg-gradient-to-bl rounded-40" style="border: 2px solid rgba(255, 255, 255, 0.2); backdrop-filter: blur(25px);">
